## pal_maps (humble) - 0.5.0-1

The packages in the `pal_maps` repository were released into the `humble` distro by running `/usr/bin/bloom-release --track humble --rosdistro humble pal_maps -y` on `Wed, 11 Feb 2026 08:09:58 -0000`
